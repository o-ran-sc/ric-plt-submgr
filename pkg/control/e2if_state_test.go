...
func (x *XappRnibMock) Init() {
	...
	x.CreateGnb("RAN_NAME_1", entities.ConnectionStatus_CONNECTED)
	x.CreateGnb("RAN_NAME_11", entities.ConnectionStatus_CONNECTED)
	x.CreateGnb("RAN_NAME_2", entities.ConnectionStatus_CONNECTED)

	x.CreateGnb("gnb_208_092_303030", entities.ConnectionStatus_CONNECTED) // This same value is used in gnb simulator!
	x.CreateGnb("gnb_369_11105_aaaaa8", entities.ConnectionStatus_DISCONNECTED)
...
func TestSomething(t *testing.T) {
	...
	x.CreateGnb("gnb_208_092_303030", entities.ConnectionStatus_CONNECTED)   	// This same value is used in gnb simulator!
	x.CreateGnb("gnb_369_11105_aaaaa8", entities.ConnectionStatus_DISCONNECTED)
	x.CreateGnb("gnb_369_11105_aaaaa7", ConnectionStatus_UNKNOWN_CONNECTION_STATUS)
	x.CreateGnb("gnb_369_11105_aaaaa6", onnectionStatus_CONNECTED_SETUP_FAILED)
	x.CreateGnb("gnb_369_11105_aaaaa5", ConnectionStatus_CONNECTING)
	x.CreateGnb("gnb_369_11105_aaaaa4", ConnectionStatus_SHUTTING_DOWN)
	x.CreateGnb("gnb_369_11105_aaaaa3", ConnectionStatus_SHUT_DOWN)

	//x.CreateGnb("gnb_208_092_303030", entities.ConnectionStatus_DISCONNECTED)   // DISCONNECTED.
...
func (x *XappRnibMock) CreateGnb(gnbId string, connectionStatus entities.ConnectionStatus) {
	...
	err := x.XappRnibSaveNodeb(nbIdentity, &nb)
	if err != nil {
...
func (x *XappRnibMock) XappRnibGetListGnbIds() ([]*xapp.RNIBNbIdentity, xapp.RNIBIRNibError) {
	...
	for _, nbIdentity := range x.nbIdentityMap {
		nbIdentities = append(nbIdentities, &nbIdentity)
	}
