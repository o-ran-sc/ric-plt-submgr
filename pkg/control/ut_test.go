...
func ut_test_init() {
	...
	*/
	...
	mainCtrl = createSubmgrControl(rtfilename, 14560, 14561)

	//---------------------------------
	//
	//---------------------------------
	tent.Logger.Info("### xapp1 stub run ###")
	xappConn1 = teststube2ap.CreateNewE2Stub("xappstub1", rtfilename, 13560, 13561, "RMRXAPP1STUB", 55555)

	//---------------------------------
	//
	//---------------------------------
	tent.Logger.Info("### xapp2 stub run ###")
	xappConn2 = teststube2ap.CreateNewE2Stub("xappstub2", rtfilename, 13660, 13661, "RMRXAPP2STUB", 55555)

	//---------------------------------
	//
	//---------------------------------
	tent.Logger.Info("### e2term1 stub run ###")
	e2termConn1 = teststube2ap.CreateNewE2termStub("e2termstub1", rtfilename, 15560, 15561, "RMRE2TERMSTUB1", 55555)

	//---------------------------------
	//
	//---------------------------------
	tent.Logger.Info("### e2term2 stub run ###")
	e2termConn2 = teststube2ap.CreateNewE2termStub("e2termstub2", rtfilename, 15660, 15661, "RMRE2TERMSTUB2", 55555)

	//---------------------------------
	// Just to test dummy stub
	//---------------------------------
	tent.Logger.Info("### dummy stub run ###")
	dummystub = teststubdummy.CreateNewRmrDummyStub("dummystub", rtfilename, 16560, 16561, "DUMMYSTUB", 55555)
