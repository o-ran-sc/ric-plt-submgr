...
typedef struct {
    ...
    ActionParameterItem_t actionParameterItem[255]; // 255 // OPTIONAL. 1..255 (maxofRANParameters)
...
typedef struct {
	...
	RANueGroupDefItem_t ranUeGroupDefItem[255]; // 255 //OPTIONAL. 1..255 (maxofRANParameters)
} RANueGroupDefinition_t;

typedef struct {
    uint8_t ranParameterCount;
	RANParameterItem_t ranParameterItem[255]; // 255 //OPTIONAL. 1..255 (maxofRANParameters)
