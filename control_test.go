...
func initMock() *Control {
	...
	meid := &xapp.RMRMeid{}
	meid.RanName = "gnb_351_23_8712435_fd72bc3f"
	...
	clientService := &handle.ClientServiceMock{}
	C1.registry.rtmgrClient.rtClient.Handle = clientService
	clientService.On("ProvideXappSubscriptionHandle", mock1.Anything).Return(&handle.ProvideXappSubscriptionHandleCreated{}, nil)
	clientService.On("DeleteXappSubscriptionHandle", mock1.Anything).Return(&handle.DeleteXappSubscriptionHandleOK{}, &handle.DeleteXappSubscriptionHandleNoContent{}, nil)
...
func TestControl_handleE2TSubscriptionDeleteRequired(t *testing.T) {
	handler := initMock()
       fmt.Println("#####################  TestControl_handleE2TSubscriptionDeleteRequired#####################")
...
func TestE2ap_UnpackSubscriptionDeleteRequired(t *testing.T) {
        fmt.Println("#####################  TestE2ap_UnpackSubscriptionDeleteRequired #####################")
	var payload = []byte{0, 12, 64, 20, 0, 0, 1, 0, 50, 64, 13, 1, 0, 51, 64, 8, 0, 0, 123, 0, 1, 0, 2, 86}
	var e2ap1 = E2ap{}
